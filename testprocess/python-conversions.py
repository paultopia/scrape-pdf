...
# for some reason, every source I can find on encoding doesn't use a lib but decoding does.  okaaaaaay...

with open("out.pdf", "wb") as outpdf:
    outpdf.write(pdfbytes)

# I have also verified that this decoding code produces the correct pdf file when copied and pasted from
# javascript console (even though line breaks are in a different place and diffing doesn't really work)
